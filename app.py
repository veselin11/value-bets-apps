...
SPORT = "soccer"  # всички футболни лиги
REGIONS = "uk,us,eu,au"
MARKETS = "h2h"
ODDS_FORMAT = "decimal"
...
st.caption("Извличане на реални стойностни залози от OddsAPI в реално време")
...
if response.status_code != 200:
    ...
    for match in data:
        # Преобразуване на време и филтриране за днешните мачове
        try:
